...
namespace Com.Yk1028.SnakeGame
{
    ...
    {
        private readonly RaiseEventOptions raiseEventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.All };
        ...
        {
            PhotonNetwork.RaiseEvent(winOthersEvent, null, raiseEventOptions, sendOptions);
        }

        public void RaiseLoseOthersEvent()
        {
            PhotonNetwork.RaiseEvent(loseOthersEvent, null, raiseEventOptions, sendOptions);
        }
